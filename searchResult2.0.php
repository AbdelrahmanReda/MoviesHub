...
if(!isset($_SESSION['userName'])&&!isset($_SESSION['adminUserName']))
{
    ...
    if(isset($_POST["FirstName"]))
    {
        ...
        $movieName = test_input($_POST["FirstName"]);
       ...
       if($data!=null)
        ...
        while($fetched2 = $data2->fetch_assoc())
        {
            ...
            $con->closeConnection();
           echo"<script>alert(\"no movie with such a name\");</script>";
    ...
    <head>
        ...
        <style>
            ...
            #BACK {
                ...
                background-image: radial-gradient(circle, rgba(36, 17, 0, 0) 0%, rgba(0, 0, 0, 1) 82%), url(https://image.zype.com/5c182d06649f0f134a001703/5cd99c0d0e6366575a9e1451/custom_thumbnail/1080.jpg?1557842415);
        ...
        <div class="container">
            ...
            <div class="modal fade" id="myModal"    data-keyboard="false" data-backdrop="static" >
                <div class="modal-dialog modal-xl">
                 ...
                 <!-- The Modal -->
            <div class="modal fade" id="myModalsss"    data-keyboard="false" data-backdrop="static"s>
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
...
for(var j=0;j<stars;j++)
    ...
    video.setAttribute("src",movieData[6]);
